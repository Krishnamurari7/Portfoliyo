      ...
      <div className="absolute inset-0 overflow-hidden">
        {isDark ? (
          <>
            ...
            <div className="absolute w-96 h-96 bg-blue-600 rounded-full blur-3xl opacity-20 -bottom-48 -right-48 animate-pulse" style={{animationDelay: '1s'}}></div>
            <div className="absolute w-96 h-96 bg-cyan-500 rounded-full blur-3xl opacity-20 top-1/2 left-1/2 animate-pulse" style={{animationDelay: '2s'}}></div>
          </>
        ) : (
          <>
            <div className="absolute w-96 h-96 bg-blue-400 rounded-full blur-3xl opacity-15 -top-48 -left-48 animate-pulse"></div>
            <div className="absolute w-96 h-96 bg-purple-400 rounded-full blur-3xl opacity-15 -bottom-48 -right-48 animate-pulse" style={{animationDelay: '1s'}}></div>
            <div className="absolute w-96 h-96 bg-pink-300 rounded-full blur-3xl opacity-15 top-1/2 left-1/2 animate-pulse" style={{animationDelay: '2s'}}></div>
          </>
        )}
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 lg:space-y-12">
          ...
          <div className="inline-block mb-6 animate-bounce">
            <div className={`flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-sm transition-all duration-300 ${
              ...
              <Sparkles className={`w-4 h-4 ${isDark ? 'text-purple-400' : 'text-blue-500'}`} />
              <span className={`text-sm ${isDark ? 'text-purple-300' : 'text-blue-600'}`}>
          ...
          <div className="space-y-4 animate-fade-in" style={{animationDelay: '0.1s'}}>
            ...
            {/* Subtitle */}
            <p className={`text-2xl sm:text-3xl lg:text-4xl font-light bg-clip-text text-transparent ${
              isDark
          ...
          {/* Description */}
          <p className={`text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-light ${
            isDark ? 'text-slate-400' : 'text-slate-600'
          }`}>
            Crafting beautiful, high-performance web experiences with modern technologies. 
            Specializing in full-stack development, clean code, and innovative solutions.
          </p>
