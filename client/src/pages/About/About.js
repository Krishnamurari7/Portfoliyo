          ...
          <div className="row">
            ...
            <div className="col-md-6 col-xl-6 col-lg-6 col-xs-12 about-content">
              ...
              <p>Hello EveryOne,
                    ...
                    I Have Deep Interest In Devlopment and I have made Many FullStack Project Using HTML, CSS, Javascript, React.js, Node.js, Express.js, Mongoose, Mongodb, tailwind.
